...
import com.example.sampletask.databinding.SingleVideoScreenBinding
...
class VideoAdapter(
    ...
    class VideoViewHolder(
        val binding: SingleVideoScreenBinding,
        var context: Context,
        var videoPreparedListener: OnVideoPreparedListener
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoViewHolder {
        val view = SingleVideoScreenBinding.inflate(LayoutInflater.from(context), parent, false)
